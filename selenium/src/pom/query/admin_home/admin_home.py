...
class AdminHomeQuery:
    ...
    def has_welcome_message(self, for_user: str) -> bool:
        return self.custom_selenium.has_text(
            AdminHomeUI.welcome_selector, f"Bem Vindo {for_user}", strict=True, should_wait=True
        )

    def is_store_description_visible(self) -> bool:
        return self.custom_selenium.is_displayed(AdminHomeUI.store_description, should_wait=True)
