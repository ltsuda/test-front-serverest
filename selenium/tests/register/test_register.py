...
class TestLogin:
    ...
    def test_admin_register_redirected_to_home(self, driver: WebDriver, admin_user):
        ...
        assert _alert_query.is_alert_visible(with_text="Cadastro realizado com sucesso")
    ...
    def test_alert_email_already_in_use(self, driver: WebDriver, user_account):
        ...
        assert _alert_query.is_alert_visible(with_text="Este email já está sendo usado")
